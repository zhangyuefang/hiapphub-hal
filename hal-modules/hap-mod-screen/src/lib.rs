...
hap_common::hap_module_init!("screen");
...
mod tests {
    ...
    fn test_list_displays() {
        let r = call(super::funcs::hap_screen_list_displays, serde_json::json!({}));
        assert!(r.is_array());
    }

    #[test]
    fn test_active_window() {
        let r = call(super::funcs::hap_screen_active_window, serde_json::json!({}));
